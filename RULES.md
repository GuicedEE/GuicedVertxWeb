...
- GuicedEE Vert.x Web (modular rules): [rules/generative/backend/guicedee/web/](rules/generative/backend/guicedee/web/) with spi-configurators.rules.md, server-configuration.rules.md, router-configuration.rules.md, use-cases.rules.md, module-info.rules.md, lifecycle.rules.md, best-practices.rules.md
