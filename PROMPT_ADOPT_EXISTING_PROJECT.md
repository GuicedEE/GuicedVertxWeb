...
- Repository URL / local path: https://github.com/GuicedEE/GuicedVertxWeb.git
- Org and project name: GuicedEE / GuicedVertxWeb (artifact: guiced-vertx-web)
- Short description: Configures the GuicedEE Vert.x Web server and router via SPI (HTTP/HTTPS options, TLS/keystore, body/static handlers, router/server configurators).
- License (if missing or to change): Apache 2.0
