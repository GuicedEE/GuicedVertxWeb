...
- Library name: Guiced Vert.X Web
- Current/new version: <VERSION>
- Repository URL / path: https://github.com/GuicedEE/GuicedVertxWeb.git
- Rules repository location: generative/backend/guicedee/web
